...
import engine
from engine.dist import get_dist_info
from engine.fileio import FileClient, get_file_backend
from engine.fileio import load as load_file
from engine.logging import print_log
from models import BaseTTAModel, is_model_wrapper
...
def get_torchvision_models():
    ...
    if digit_version(torchvision.__version__) < digit_version('0.13.0a0'):
        ...
        json_path = osp.join(engine.__path__[0], 'hub/torchvision_0.12.json')
        model_urls = engine.load(json_path)
...
def get_external_models():
    ...
    default_json_path = osp.join(engine.__path__[0], 'hub/openmmlab.json')
...
def get_mmcls_models():
    mmcls_json_path = osp.join(engine.__path__[0], 'hub/mmcls.json')
...
def get_deprecated_model_names():
    deprecate_json_path = osp.join(engine.__path__[0], 'hub/deprecated.json')
