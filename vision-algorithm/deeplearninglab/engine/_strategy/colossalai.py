...
from engine.dist import init_dist, is_main_process
from engine.fileio import join_path
from models import BaseDataPreprocessor
from engine.optimizers import BaseOptimWrapper, OptimWrapper
from engine.schedulers import _ParamScheduler
from registry import STRATEGIES, Registry
from registry.root import MODEL_WRAPPERS, OPTIM_WRAPPERS, OPTIMIZERS
from engine.runner.checkpoint import _load_checkpoint, save_checkpoint
    ...
    def save_checkpoint(
        ...
        *,
        ...
        extra_ckpt['meta'].update(
            ...
            mmengine=engine.__version__ + get_git_hash())
