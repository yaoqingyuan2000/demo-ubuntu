...
import engine.fileio as fileio
from ...utils import image as impots
...
from .processing import Pad as MMCV_Pad
from .processing import RandomFlip as MMCV_RandomFlip
from .processing import Resize as MMCV_Resize
    ...
    def _resize_img(self, results):
        ...
        if results.get('img', None) is not None:
            if self.keep_ratio:
                ...
                img, w_scale, h_scale = impots.imresize(
                    results['img'],
                    results['scale'],
                    interpolation=self.interpolation,
                    return_scale=True,
...
class FixShapeResize(Resize):
    ...
    def transform(self, results: dict) -> dict:
        ...
        if self.keep_ratio:
            ...
            img, scale_factor = impots.imrescale(
...
class RandomFlip(MMCV_RandomFlip):
    ...
    def _flip(self, results: dict) -> None:
        ...
        if results.get('gt_seg_map', None) is not None:
            results['gt_seg_map'] = impots.imflip(
...
class SegRescale(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        if self.scale_factor != 1:
            results['gt_seg_map'] = impots.imrescale(
                results['gt_seg_map'],
                self.scale_factor,
...
class MixUp(BaseTransform):
    ...
    def transform(self, results: dict) -> dict:
        ...
        out_img = impots.imresize(out_img, (int(out_img.shape[1] * jit_factor),
...
class LoadAnnotations(BaseTransform):
    ...
    def _load_seg_map(self, results: dict) -> None:
        ...
        results['gt_seg_map'] = impots.imfrombytes(
